import { Misdemeanour, MisdemeanourKind, MISDEMEANOURS } from "../types/misdemeanours.types";

export async function generateMisdemeanours(number: number): Promise<Array<Misdemeanour>> {
